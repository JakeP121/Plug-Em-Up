...
public class KeyboardGrid : MonoBehaviour {
    ...
    private void setupGrid()
    {
        ...
        rows[0] = new KeyboardRow(game, KeyCode.Q, KeyCode.W, KeyCode.E, KeyCode.R, KeyCode.T, KeyCode.Y, KeyCode.U, KeyCode.I, KeyCode.O, KeyCode.P);
        rows[1] = new KeyboardRow(game, KeyCode.A, KeyCode.S, KeyCode.D, KeyCode.F, KeyCode.G, KeyCode.H, KeyCode.J, KeyCode.K, KeyCode.L);
